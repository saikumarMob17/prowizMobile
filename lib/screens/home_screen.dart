...
import 'package:prowiz/screens/cameras_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  //  homeController.loginResponseModel = widget.model!;
  ...
  Widget build(BuildContext context) {
    ...
    final homeController = Get.find<LoginController>();


    log("homeController.notchBottomBarController.value ===> ${homeController.camerasList}");

    final List<Widget> bottomBarPages = [
      CameraScreen(
        controller1: homeController.notchBottomBarController.value,
        camerasController: homeController,
      ),
      //  const SettingScreen(),
      AccountScreen(
          ...
          bottomNavigationBar: (bottomBarPages.length <= maxCount)
              ? Obx(() => AnimatedNotchBottomBar(
                    ...
                    notchBottomBarController:
                        homeController.notchBottomBarController.value,
                    ...
                    bottomBarItems: [
                      BottomBarItem(
                          inActiveItem:
                              Image.asset(ConstantImages.bottomNavIcon1),
                          activeItem:
                              Image.asset(ConstantImages.bottomNavIcon1),
                      ...
                      BottomBarItem(
                          inActiveItem:
                              Image.asset(ConstantImages.bottomNavIcon2),
                          activeItem:
                              Image.asset(ConstantImages.bottomNavIcon2),
                          itemLabelWidget: const CustomTextWidget(
                            text: "Account",
